...
Write-Host "  - he firstpush <nom> [-pr|-pu]  : Creer un nouveau repo et pusher" -ForegroundColor Gray
Write-Host "  - he startpush <url>            : Pusher vers un repo existant" -ForegroundColor Gray
